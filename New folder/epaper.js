...
function exist(){
    ...
    usermessage.innerText = "Email that You've Entered is already exist please use diffrent one"
    let container = document.querySelector("body")
    
    document.querySelector("html").style.backgroundColor = "rgb(41 42 44 / 50%)"
